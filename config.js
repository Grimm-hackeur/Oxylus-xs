...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://zephyr:Zephyr@zephyrxenix.a074kzk.mongodb.net/?appName=zephyrxenix',
    ...
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb6ogA1BPzjflMFKfp1e',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '7214172448:AAHGqSgaw-zGVPZWvl8msDOVDhln-9kExas',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8678028581'
